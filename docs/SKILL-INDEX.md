...
## Cerulean Domain Skills

Installed in `.agents/skills/`. **Use these first** for Cerulean work.
...
**What it does:** Railway + self-hosted Supabase checklist, migrations, env vars, verification steps.
**References:** `docs/DEPLOYMENT.md`

### `cerulean-mcp`
**Triggers:** MCP setup, Cursor/Antigravity, `cerulean_*` tools, API keys, IDE workflow
**What it does:** MCP config, session flow, tool reference, patch accept rules.
**References:** `docs/MCP-AGENT-GUIDE.md`, `docs/WHAT-IS-MCP.md`
